    ...
    <div className={style.UserInfo__details}>
      ...
      <div className={style.UserInfo__details__container}>
        <div className={style.UserInfo__details__container__item}>
          ...
          <span
            className={style.UserInfo__details__container__item__value}
    ...
    <div className={style.UserInfo__details}>
      ...
      <div className={style.UserInfo__details__container}>
        ...
        >
          ...
          <span
            className={style.UserInfo__details__container__item__value}
            data-testid="user-education-level"
          >
        ...
        >
          ...
          <span
            className={style.UserInfo__details__container__item__value}
            data-testid="user-employment-status"
          >
        ...
        >
          ...
          <span
            className={style.UserInfo__details__container__item__value}
            data-testid="user-employment-duration"
          >
        ...
        >
          ...
          <span
            className={style.UserInfo__details__container__item__value}
            data-testid="user-education-official-email"
          >
        ...
        >
          ...
          <span
            className={style.UserInfo__details__container__item__value}
            data-testid="user-education-monthly-income"
          >
            {`${
              data?.profile.currency == "NGN" ? "₦" : data?.profile.currency
        ...
        >
          ...
          <span
            className={style.UserInfo__details__container__item__value}
            data-testid="user-education-loan"
          >
            {`${
              data?.profile.currency == "NGN" ? "₦" : data?.profile.currency
