...
test("USerInfo component is rendered", () => {
  ...
  const userEducationOfficialEmail = screen.getByTestId(
    "user-education-official-email"
  );
  const userEducationMonthlyIncome = screen.getByTestId(
    "user-education-monthly-income"
  );
